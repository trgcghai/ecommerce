  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          ...
          >
            ...
            <p className="font-inter text-base font-medium tracking-normal leading-normal text-center mr-2">
              Shopping bag
            </p>
          </div>
      ...
      <div className="bg-black p-4 w-full flex justify-around">
        <div className="text-white font-inter text-base font-medium tracking-normal leading-normal text-center">
          50% SALE OFF
        </div>
        <div className="text-white font-inter text-base font-medium tracking-normal leading-normal text-center">
